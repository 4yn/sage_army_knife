...
# This file was *autogenerated* from the file sage_army_knife/stolen/dh_backdoor.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2)# by mimoo from https://github.com/mimoo/Diffie-Hellman_Backdoor
...
def CM_HSO(modulus_size, small_factors_size, big_factor_size, generator=_sage_const_0 , debug=False):
