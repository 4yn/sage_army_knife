...
# This file was *autogenerated* from the file sage_army_knife/stolen/boneh_durfee.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_60 = Integer(60); _sage_const_7 = Integer(7); _sage_const_2 = Integer(2); _sage_const_0p18 = RealNumber('0.18'); _sage_const_4 = Integer(4); _sage_const_0p292 = RealNumber('0.292')# by mimoo from https://github.com/mimoo/RSA-and-LLL-attacks
...
def remove_unhelpful(BB, monomials, bound, current, debug=False, dimension_min=_sage_const_7 ):
    ...
    for ii in range(current, -_sage_const_1 , -_sage_const_1 ):
        ...
        if BB[ii, ii] >= bound:
            ...
            if affected_vectors == _sage_const_0 :
                ...
                monomials.pop(ii)
                BB = remove_unhelpful(BB, monomials, bound, ii-_sage_const_1 , debug, dimension_min)
                return BB
...
"""
def boneh_durfee(pol, modulus, mm, tt, XX, YY, debug=False, strict=False, helpful_only=True, dimension_min=_sage_const_7 ):
    """
    ...
    * |y| < e^0.5
    ...
    if helpful_only:
        ...
        BB = remove_unhelpful(BB, monomials, modulus**mm, nn-_sage_const_1 , debug, dimension_min)
        # reset dimension
...
def boneh_durfee_attack(N, e, delta=_sage_const_0p18 , m=_sage_const_4 , debug=False, strict=False, helpful_only=True, dimension_min=_sage_const_7 ):
    ############################################
